...
{
    public partial class Wallpaper2 : Form
    {
        private int Timer = 0;
        private int i = 0;
        ...
        private void Wallpaper2_Load(object sender, EventArgs e)
        {
            timer1.Start();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            Label[] Targeter = new Label[] {labelTargeter1, labelTargeter2, labelTargeter3, labelTargeter4};
            ...
            Targeter[i].BackColor = Color.DodgerBlue;
            ...
            if (Timer == 100)
            {
                Targeter[i].BackColor = Color.AliceBlue;
                Timer = 0;
                i++;
            }
        ...
        private void LabelTarget()
        {
            Produit[] P = new Produit[] { P1, P2, P3, P4 };
            Label[] Targeter = new Label[] { labelTargeter1, labelTargeter2, labelTargeter3, labelTargeter4 };

            for (int j = 0; j < Targeter.Length; j++)
            {
                Targeter[i].BackColor = Color.AliceBlue;
                
            }
        }
        private void labelTargeter1_Click(object sender, EventArgs e)
        {
            LabelTarget();
        ...
        private void labelTargeter2_Click(object sender, EventArgs e)
        {
            LabelTarget();
        ...
        private void labelTargeter3_Click(object sender, EventArgs e)
        {
            LabelTarget();
        ...
        private void labelTargeter4_Click(object sender, EventArgs e)
        {
            LabelTarget();
        ...
        private void pictureBoxWall_MouseHover(object sender, EventArgs e)
        {
            //Display comment when user'mouse **HOVER** above the picture picturerbox zone:

            //To use that just use Tooltip in Design Form
